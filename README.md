...
The extension is inert outside CMUX. If `CMUX_WORKSPACE_ID` is not set, it does nothing. It does not write CMUX workspace descriptions, workspace titles, logs, or notifications.
